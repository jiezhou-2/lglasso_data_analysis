...
*  All the simulation are implemented based on the R function `power_compare1`, which has the following form ``result= power_compare1(m,n,p,coe,l,rho,prob,heter,community2,zirate) ``
where 
